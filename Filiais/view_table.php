...
<table>
    <thead>
        <tr>
            ...
            <th data-col="Numero"><div class="th-wrap">Nº Amostra <span class="filter-btn">🔽</span></div></th>
            <th data-col="Coleta"><div class="th-wrap">Data Coleta <span class="filter-btn">🔽</span></div></th>
            <th data-col="Chegada"><div class="th-wrap">Chegada <span class="filter-btn">🔽</span></div></th>
            <th data-col="Recebimento"><div class="th-wrap">Data Recebimento <span class="filter-btn">🔽</span></div></th>
            <th data-col="Entrega"><div class="th-wrap">Previsão Entrega <span class="filter-btn">🔽</span></div></th>
            <th data-col="Unidade"><div class="th-wrap">Unidade Serviço <span class="filter-btn">🔽</span></div></th>
            <th data-col="Empresas"><div class="th-wrap">Empresas <span class="filter-btn">🔽</span></div></th>
            <th data-col="Pendencia"><div class="th-wrap">Pendência <span class="filter-btn">🔽</span></div></th>
            <th data-col="Dias"><div class="th-wrap">Dias Atrasos <span class="filter-btn">🔽</span></div></th>
...
function exportarExcel() {
    let csv = "\uFEFFCódigo;Grupo;Número;Coleta;Chegada;Recebimento;Entrega;Unidade;Empresas;Pendência;Dias;Status\n";

    dadosFiltrados.forEach(r => {
        csv += `${r.Codigo};${r.Grupo};${r.Numero};${r.Coleta};${r.Chegada};${r.Recebimento};${r.Entrega};${r.Unidade};${r.Empresas};${r.Pendencia};${r.Dias};${r.Status}\n`;
    });
